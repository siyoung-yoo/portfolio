    ...
    new Swiper(".main-swiper", {
        ...
        on: {
            ...
            slidePrevTransitionStart: function() {
                ...
                TweenMax.staggerTo(prevSlide, 0.5, {scale:1.1, x:-100, opacity:0, ease:Power3.easeInOut}, 0.02)
                TweenMax.staggerTo(activeSlide, 0.5, {scale:1, x:0, opacity:1, scale:1, delay:0.5, ease:Power3.easeOut}, 0.02)
                TweenMax.staggerTo(nextSlide, 0.5, {scale:0.9, x:100, opacity:0, ease:Power3.easeInOut}, 0.02)
            },
            slideNextTransitionStart: function() {
                ...
                TweenMax.staggerTo(prevSlide, 0.5, {scale:0.9, x:-100, opacity:0, ease:Power3.easeInOut}, 0.02)
                TweenMax.staggerTo(activeSlide, 0.5, {scale:1, x:0, opacity:1, scale:1, delay:0.3, ease:Power3.easeOut}, 0.02)
                TweenMax.staggerTo(nextSlide, 0.5, {scale:1.1, x:100, opacity:0, ease:Power3.easeInOut}, 0.02)
            },
