    ...
    var _componentColorPicker = function() {
        ...
        $('.colorpicker-event-change').spectrum({
            change: function(c) {
                ...
                label.removeClass('hidden').html('Change called: ' + '<span class="font-medium">' + c.toHexString() + '</span>');
            }
        });
        ...
        $('.colorpicker-event-move').spectrum({
            move: function(c) {
                ...
                label.removeClass('hidden').html('Move called: ' + '<span class="font-medium">' + c.toHexString() + '</span>');
            }
        });
        ...
        $('.colorpicker-event-hide').spectrum({
            hide: function(c) {
                ...
                label.removeClass('hidden').html('Hide called: ' + '<span class="font-medium">' + c.toHexString() + '</span>');
            }
        });
        ...
        $('.colorpicker-event-show').spectrum({
            show: function(c) {
                ...
                label.removeClass('hidden').html('Show called: ' + '<span class="font-medium">' + c.toHexString() + '</span>');
            }
        });
        ...
        $('.colorpicker-event-dragstart').on('dragstart.spectrum', function (e, c) {
            ...
            label.removeClass('hidden').html('Dragstart called: ' + '<span class="font-medium">' + c.toHexString() + '</span>');
        });
        ...
        $('.colorpicker-event-dragstop').on('dragstop.spectrum', function (e, c) {
            ...
            label.removeClass('hidden').html('Dragstop called: ' + '<span class="font-medium">' + c.toHexString() + '</span>');
        });
    };
