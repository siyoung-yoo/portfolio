...
$.extend( FixedColumns.prototype , {
		...
		var nSWrapper =
			$('<div class="DTFC_ScrollWrapper" style="position:relative; clear:both;">'+
				'<div class="DTFC_LeftWrapper" style="position:absolute; top:0; left:0;" aria-hidden="true">'+
					'<div class="DTFC_LeftHeadWrapper" style="position:relative; top:0; left:0; overflow:visible;"></div>'+
					'<div class="DTFC_LeftBodyWrapper" style="position:relative; top:0; left:0; height:0; overflow:visible;">'+
						'<div class="DTFC_LeftBodyLiner" style="position:relative; top:-1px; left:0; overflow-y:visible;"></div>'+
					'</div>'+
				...
				'<div class="DTFC_RightWrapper" style="position:absolute; top:0; right:0;" aria-hidden="true">'+
					...
					'<div class="DTFC_RightBodyWrapper" style="position:relative; top:0; left:0; height:0; overflow:hidden;">'+
						'<div class="DTFC_RightBodyLiner" style="position:relative; top:-1px; left:0; overflow-y:scroll;"></div>'+
					'</div>'+
	...
	"_fnGridLayout": function ()
	{
		...
		if ( this.s.iLeftColumns > 0 )
		{
			...
			oGrid.left.body.style.height = iFullHeight - 35 +"px";
			if ( oGrid.left.foot ) {
				oGrid.left.foot.style.top = (oOverflow.x ? oOverflow.bar : 0)+"px"; // shift footer for scrollbar
			}

			scrollbarAdjust( oGrid.left.liner, iLeftWidth );
			oGrid.left.liner.style.height = iFullHeight - 35 +"px";
			oGrid.left.liner.style.maxHeight = iFullHeight - 35 +"px";
		}
